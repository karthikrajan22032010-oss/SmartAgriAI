...
export const ta: typeof en = {
  ...
  // ── Rain & Weather ───────────────────────────────────
  rainProbability: 'மழை சாத்தியக்கூறு',
  rainAlert: 'மழை எச்சரிக்கை அறிவிப்பு',
  rainHigh: 'மழை வாய்ப்பு அதிகம் (🌧️ எச்சரிக்கை)',
  rainModerate: 'மிதமான வாய்ப்பு (மேகமூட்டம்)',
  rainLow: 'குறைந்த வாய்ப்பு (வறண்ட வானிலை)',
  rainDelayIrrigation: 'மழை பெய்ய வாய்ப்புள்ளது. நீர்ப்பாசனத்தை ஒத்திவைக்கவும்.',
  rainNormalIrrigation: 'வறண்ட நிலை. வழக்கமான நீர்ப்பாசனத்தை தொடரலாம்.',

  // ── AI Chat ───────────────────────────────────────────
  askAI: 'AI விவசாய உதவியாளரிடம் கேளுங்கள்',
  askAIPlaceholder: 'பயிர்கள், மண், மழை வாய்ப்பு, பூச்சி மேலாண்மை பற்றி கேளுங்கள்...',
  askAIButton: 'கேள்வி கேள்',
  aiTyping: 'AI சிந்திக்கிறது...',
  suggestedQuestions: 'விரைவு கேள்விகள்',

  // ── Camera HD ─────────────────────────────────────────
  hdMode: 'HD பயன்முறை',
  hdStream: 'HD நேரலை ஸ்ட்ரீம்',
  expandStream: 'பெரிதாக்கு',
  compactStream: 'சுருக்கு',
